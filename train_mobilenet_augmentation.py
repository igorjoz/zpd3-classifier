...
def main():
    ...
    parser.add_argument(
        "--output-dir", type=Path, default=Path("augmentation_outputs") / "mobilenet_v3_large"
    )
    parser.add_argument("--models-dir", type=Path, default=Path("MODELS_IMPROVED/augmentation"))
