...
| ---: | ---: | ---: | ---: | --- |
| 1 | 13 | 0.7731 | 5.7404 | fine_tune |
| 2 | 10 | 0.7590 | 5.7181 | fine_tune |
| 3 | 9 | 0.7544 | 6.4236 | fine_tune |

Najlepszy checkpoint pochodzi z epoki `13`: validation accuracy `0.7839`, macro F1 `0.7731`, ROC-AUC `0.9441`.
...
| ---: | ---: | ---: | ---: | ---: |
| 1.9028 | 0.8462 | 0.8433 | 0.8427 | 0.9800 |

## Analiza wyboru

- Roznica train-validation macro F1 w najlepszej epoce wynosi `0.2139`, co wskazuje na przeuczenie. Nastepny eksperyment powinien zwiekszyc regularyzacje lub skrocic fine-tuning.
...
- `MODELS_IMPROVED/hyperparams/*.pt`: trzy najlepsze modele na podstawie walidacji.
